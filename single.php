...
?>
    <!DOCTYPE html>
<html data-wf-page="686931998f03c728d6fcf422" data-wf-site="686931998f03c728d6fcf388" lang="ru">
  ...
  width: 100%;
		...
		<section class="section_food">
			<div class="container-xl standart-page">
				<div class="rich-text-block w-richtext"><?php if(have_posts()) : ?><?php while (have_posts()) : the_post(); ?>
					<div><?php the_content(); ?></div>
				<?php endwhile; ?><?php endif; ?></div>
				<div class="code_block"><?php echo get_field('vstavka_koda') ?></div>
			</div>
		</section>
		<div>
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/single.js?ver=1789049048"></script></body>
</html>
