...
?>
    <!DOCTYPE html>
<html data-wf-page="686931998f03c728d6fcf408" data-wf-site="686931998f03c728d6fcf388" lang="ru">
	<?php get_template_part("header_block", ""); ?>
	<body>
<?php if(function_exists('get_field')) { echo get_field('body_code', 'option'); } ?>

		<?php if( have_rows('bloki_stranicy_meropriyatiya') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Блоки страницы Мероприятия"; $loop_field = "bloki_stranicy_meropriyatiya"; while( have_rows('bloki_stranicy_meropriyatiya') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div>
			<div>
				<div class="w-embed">
					<style>.w-nav-overlay {
	margin-top: 60px;
...
.nav-button:hover::after {
  width: 100%;
			...
			<?php if( have_rows('pervaya_sekciya') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Первая секция"; $loop_field = "pervaya_sekciya"; while( have_rows('pervaya_sekciya') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div>
				<section class="section_same-page events" style="background-image:url('<?php $field = get_sub_field('izobrazhenie_verhnej_sekcii'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>');">
						...
						<div class="about-us_grid">
							<div class="what-to-do_text-block">
								<div class="aboute-us_text-block">
									...
									<h2 id="w-node-_42023b55-80dc-1b50-ea5f-1a4610fa3264-d6fcf408" class="h2 same-page-h2"><?php echo get_sub_field('zagolovok_n2') ?></h2>
			...
			<?php if(empty(get_sub_field('skryt_blok_video'))) { ?><div>
				<?php if( have_rows('video') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Видео"; $loop_field = "video"; while( have_rows('video') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><section class="section_food hide-video-merp">
					<div class="container-xl green-cont-60">
						<div class="heading_block">
							<h2 id="w-node-_42023b55-80dc-1b50-ea5f-1a4610fa329d-d6fcf408" class="h2"><?php echo get_sub_field('zagolovok_video_n2') ?></h2>
						</div>
						<div class="gallery23_component">
							<div class="gallery23_slider-video swiper video">
								<?php if( have_rows('dobavit_video') ){ ?><div class="gallery23_mask main-page swiper-wrapper"><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Добавить видео"; $loop_field = "dobavit_video"; while( have_rows('dobavit_video') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?>
			...
			<?php if( have_rows('foto') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Фото"; $loop_field = "foto"; while( have_rows('foto') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><section class="section_food">
				<div class="container-padding-20">
					<div class="container-xl green-cont-60 end">
						<div class="heading_block">
							<h2 id="w-node-_763b4e06-c63b-68f1-9497-2f539917cfba-d6fcf408" class="h2"><?php echo get_sub_field('zagolovok_foto_n2') ?></h2>
						</div>
						<div class="form-block w-form">
							<form id="search_filter_ajax" name="search_filter_ajax" data-name="search_filter_ajax" method="get" class="filter-controls" data-wf-page-id="686931998f03c728d6fcf408" data-wf-element-id="763b4e06-c63b-68f1-9497-2f539917cfbd" action="<?php echo get_home_url() ?>/index.php#results" data-action="search_filter_ajax"><input type="hidden" name="post_type" value="attachment">
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/meropriyatiya.js?ver=1789049048"></script></body>
</html>
