<?php
/*
Template name: Корпоратив
*/
?>
    <!DOCTYPE html>
<html data-wf-page="686931998f03c728d6fcf41c" data-wf-site="686931998f03c728d6fcf388" lang="ru">
	<?php get_template_part("header_block", ""); ?>
	<body>
<?php if(function_exists('get_field')) { echo get_field('body_code', 'option'); } ?>

		<?php if( have_rows('bloki_stranicy_korporativ') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Блоки страницы Корпоратив"; $loop_field = "bloki_stranicy_korporativ"; while( have_rows('bloki_stranicy_korporativ') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div>
			<?php if( have_rows('pervaya_sekciya') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Первая секция"; $loop_field = "pervaya_sekciya"; while( have_rows('pervaya_sekciya') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div>
				<section class="section_same-page corpoeate" style="background-image:url('<?php $field = get_sub_field('izobrazhenie_verhnej_sekcii'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>');">
					<div class="fill-bg-sect">
						<div class="container-xl same-page">
							<div class="same-box">
								<h1 class="h2 trip"><?php echo get_sub_field('zagolovok_n1') ?></h1>
...
.nav-button:hover::after {
  width: 100%;
			...
			<?php if( have_rows('my_predlagaem') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Мы предлагаем"; $loop_field = "my_predlagaem"; while( have_rows('my_predlagaem') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><section class="section_food">
				<div class="container-xl corp-count">
					<div class="corporate_grid">
						<?php if( have_rows('blok_1') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Блок 1"; $loop_field = "blok_1"; while( have_rows('blok_1') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div id="w-node-_5ebfa360-03d9-4fbb-005f-5753fd46e2af-d6fcf41c" class="entertainment_block"><img class="image-37" src="<?php $field = get_sub_field('izobrazhenie_1'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" width="500" alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" loading="lazy">
							<div class="corporate-text-block">
						...
						<?php if( have_rows('blok_2') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Блок 2"; $loop_field = "blok_2"; while( have_rows('blok_2') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div class="entertainment_block"><img class="image-37" src="<?php $field = get_sub_field('izobrazhenie_2'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" width="500" alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" id="w-node-f1e486b9-a67d-9140-7a6c-6bc17d6c1ed4-d6fcf41c" loading="lazy">
							<div class="corporate-text-block">
								<h3 class="h3-1 down-0"><?php echo get_sub_field('zagolovok_n3') ?></h3>
								<?php if( have_rows('spisok') ){ ?><ul role="list" class="list"><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Список"; $loop_field = "spisok"; while( have_rows('spisok') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?>
									<li class="list-item"><?php echo get_sub_field('punkt') ?></li>
						...
						<?php if( have_rows('blok_3') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Блок 3"; $loop_field = "blok_3"; while( have_rows('blok_3') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div id="w-node-af3e268a-47d5-50b7-4a20-09efe2fa6b5d-d6fcf41c" class="entertainment_block"><img class="image-37" src="<?php $field = get_sub_field('izobrazhenie_3'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" width="500" alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" id="w-node-af3e268a-47d5-50b7-4a20-09efe2fa6b5e-d6fcf41c" loading="lazy">
							<div id="w-node-af3e268a-47d5-50b7-4a20-09efe2fa6b5f-d6fcf41c" class="corporate-text-block">
								<h3 class="h3-1 down-0"><?php echo get_sub_field('zagolovok_n3') ?></h3>
								<?php if( have_rows('spisok') ){ ?><ul role="list" class="list"><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Список"; $loop_field = "spisok"; while( have_rows('spisok') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?>
									<li class="list-item"><?php echo get_sub_field('punkt') ?></li>
			...
			<?php if( have_rows('banner_s_bronyu') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Баннер с бронью"; $loop_field = "banner_s_bronyu"; while( have_rows('banner_s_bronyu') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div class="banner-section">
				<div class="container-xl-2 img-prom-banner">
					<div class="banner_block home">
						<div class="prom-text-block">
							...
							<?php if( have_rows('knopka') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Кнопка"; $loop_field = "knopka"; while( have_rows('knopka') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><div class="main-buttons-2"><a href="<?php echo get_sub_field('stranica') ?>" class="main-button-ht green w-button">Забронировать</a></div><?php } ?><?php } ?>
						</div><img id="w-node-c99e4608-71ee-c70d-784e-fb6e12da36c7-d6fcf41c" alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('izobrazhenie'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="image-3-1"></div>
				</div>
			</div><?php } ?><?php } ?>
			<?php if( have_rows('galereya') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Галерея"; $loop_field = "galereya"; while( have_rows('galereya') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><section class="section_food">
				<div class="container-xl gallery">
					<div class="w-layout-grid gallery9_component">
						<div class="w-layout-grid gallery9_row"><a href="#" id="w-node-_44873250-7fcf-ee99-9dd2-e98c313905ee-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto_1'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto_1');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
...
?></script></a><a href="#" id="w-node-d8f49fdf-2cab-4e0d-2593-94dfc1b99130-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto_2'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto_2');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
elseif ( is_numeric($item) ){
...
?></script></a><a href="#" id="w-node-_7808b5b7-d6a5-f5d5-5175-1f9490d280a9-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
elseif ( is_numeric($item) ){
...
?></script></a><a href="#" id="w-node-_5eea5d89-3ea9-7ae0-f7cd-1fde13f4b2b6-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto_3'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto_3');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
elseif ( is_numeric($item) ){
...
?></script></a><a href="#" id="w-node-_1956d5b3-d054-7511-0aa1-23d052dfc658-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto_4'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto_4');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
elseif ( is_numeric($item) ){
...
?></script></a><a href="#" id="w-node-_89440654-9179-67b3-5a8a-3ef43cfa1c15-d6fcf41c" class="gallery9_lightbox-link w-inline-block w-lightbox"><div class="gallery9_image-wrapper"><img alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" src="<?php $field = get_sub_field('foto_5'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" class="gallery9_image_large"></div><script type="application/json" class="w-json"><?php
$item = get_sub_field('foto_5');
if( isset($item['url']) ){
  $image_url = $item['url'];
}
elseif ( is_numeric($item) ){
...
?></script></a></div>
			...
			<?php if( have_rows('sekciya_s_kartoj') ){ ?><?php global $parent_id; if(isset($loop_id)) $parent_id = $loop_id; $loop_index = 0; $loop_title="Секция с картой"; $loop_field = "sekciya_s_kartoj"; while( have_rows('sekciya_s_kartoj') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?><section class="section_food map-corp">
				<div class="container-xl map-cont">
					<div id="ya-map" class="map_block w-node-_8ba9b61c-ceb5-2f80-2baf-3179fe780f30-d6fcf41c">
						...
						<div id="wrapMap"></div>
						<div class="map"><?php echo get_sub_field('kod_karty') ?></div><img class="image-36" src="<?php $field = get_sub_field('izobrazhenie_karty'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" height="Auto" alt="<?php echo !empty($field['alt']) ? esc_attr($field['alt']) : ''; ?>" loading="lazy">
						<div class="w-embed">
							<style>
#wrapMap {
    z-index: 3;
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/korporativ.js?ver=1789049048"></script></body>
</html>
